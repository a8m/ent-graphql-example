...
type TodoResolver interface {
	Status(ctx context.Context, obj *ent.Todo) (Status, error)
}
...
func (ec *executionContext) _Todo_status(ctx context.Context, field graphql.CollectedField, obj *ent.Todo) (ret graphql.Marshaler) {
	...
	res := resTmp.(Status)
	fc.Result = res
	return ec.marshalNStatus2todoᚐStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputTodoInput(ctx context.Context, obj interface{}) (TodoInput, error) {
	...
	for k, v := range asMap {
		...
		case "status":
			...
			it.Status, err = ec.unmarshalNStatus2todoᚐStatus(ctx, v)
			if err != nil {
				return it, err
			}
		case "priority":
...
func (ec *executionContext) unmarshalNStatus2todoᚐStatus(ctx context.Context, v interface{}) (Status, error) {
	var res Status
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNStatus2todoᚐStatus(ctx context.Context, sel ast.SelectionSet, v Status) graphql.Marshaler {
	return v
}
